...
RSpec.describe Admin::UniversitiesController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      university = University.create! valid_attributes
      get :edit, params: {id: university.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {university: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested university" do
        university = University.create! valid_attributes
        put :update, params: {id: university.to_param, university: new_attributes}, session: valid_session
        university.reload
      ...
      it "redirects to the university" do
        university = University.create! valid_attributes
        put :update, params: {id: university.to_param, university: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        university = University.create! valid_attributes
        put :update, params: {id: university.to_param, university: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested university" do
      university = University.create! valid_attributes
      expect {
        delete :destroy, params: {id: university.to_param}, session: valid_session
      }.to change(University, :count).by(-1)
    end
